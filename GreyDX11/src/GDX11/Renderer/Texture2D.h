...
namespace GDX11
{
	...
	public:
		...
		static std::shared_ptr<Texture2D> Create(GDX11Context* context, const D3D11_TEXTURE2D_DESC& texDesc, const void* data, const D3D11_SHADER_RESOURCE_VIEW_DESC& srvDesc);
	...
	private:
		Texture2D(GDX11Context* context, const D3D11_TEXTURE2D_DESC& texDesc, const void* data, const D3D11_SHADER_RESOURCE_VIEW_DESC& srvDesc);
